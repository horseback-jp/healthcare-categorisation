# Build Checklist — Bupa Intelligent Routing Agent

- [x] 1. Initialize project configuration (`gecx-config.json`, `.active-project`)
- [x] 2. Create app configuration (`cxas_app/bupa_voice_assistant/app.json`) with variables and Zephyr voice
- [x] 3. Create agent configuration and XML instructions (`bupa_voice_assistant`)
